...
/**
 * Protobuf message : aruba_telemetry.BTCompanyID
 */
class BTCompanyID extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \aruba_telemetry\BTCompanyID) {
